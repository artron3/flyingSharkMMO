 ...
 * @author cailloux
 */
public class OilCollision  extends RigidBodyControl implements PhysicsCollisionListener, PhysicsTickListener {
    ...
    public OilCollision(CollisionShape shape, float mass) {
        super(shape, mass);
        createGhostObject();
    }

    public OilCollision(AssetManager manager, CollisionShape shape, float mass) {
        super(shape, mass);
        createGhostObject();
    ...
    public void collision(PhysicsCollisionEvent event) {
        if (event.getObjectA() == this) {
            if (event.getObjectB() instanceof BombControl){
             ...
             System.out.println("AAAAAAAAA DETECTED COLL  AAAAAAA");
            }
        }else if (event.getObjectB() == this) {
            if (event.getObjectA() instanceof BombControl ){
            System.out.println("BBBBBBB  DETECTED COLL BBBBBBBBBBB");
                this.isDestroyed=true;
            }
        }
